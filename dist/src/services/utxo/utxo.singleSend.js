...
const singleSendUTXO = (address, feeRate, userUtxo, amount, holderStatus) => __awaiter(void 0, void 0, void 0, function* () {
    let redeemFee = network_config_1.SEND_UTXO_FEE_LIMIT;
    let redeemPsbt = (0, utxo_singleSendPsbt_1.redeemSingleSendUTXOPsbt)(wallet, userUtxo, networkType, amount, redeemFee, holderStatus);
    redeemPsbt = wallet.signPsbt(redeemPsbt, wallet.ecPair);
    redeemFee = redeemPsbt.extractTransaction(true).virtualSize() * feeRate;
    let psbt = (0, utxo_singleSendPsbt_1.singleSendUTXOPsbt)(wallet, userUtxo, networkType, redeemFee, address, amount, holderStatus);
