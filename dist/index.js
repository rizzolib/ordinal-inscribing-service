...
exports.app = exports.iterator = exports.flagMutex = void 0;
...
const send_ordinals_route_1 = require("./src/routes/send.ordinals.route");
const http_1 = __importDefault(require("http"));
const network_config_1 = require("./src/config/network.config");
const async_mutex_1 = require("async-mutex");
exports.flagMutex = new async_mutex_1.Mutex();
exports.iterator = new async_mutex_1.Mutex();
/*
 ...
 */
let swaggerDocument = "";
if (process.env.NETWORKTYPE == network_config_1.TESTNET) {
    swaggerDocument = yamljs_1.default.load("swagger_devnet.yaml");
}
else {
    swaggerDocument = yamljs_1.default.load("swagger_mainnet.yaml");
}
...
exports.app.use("/api/sendOrdinal", send_ordinals_route_1.SendOrdinalRouter);
