...
export const redeemReinscribeAndUtxoSendPsbt = (wallet: any, inputUtxoArray: Array<IUtxo>, networkType: string, amount: number, reinscriptionUTXO: IUtxo, fee: number): Bitcoin.Psbt => {
